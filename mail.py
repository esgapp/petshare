          	...
          	<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
          		<tr>
          			<td class="logo" style="text-align: center;">
			            <h1><a font-size: 40px; href="#">Petsify</a></h1>
			          </td>
          		</tr>
          	</table>
          </td>
            	...
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 2.5em; text-align: center;">
                            ...
                            <p><a href="jhyfgrkujghghfdsdfgdvb" class="btn btn-primary">Visit our page</a></p>
            			</div>
            		</td>
            	</tr>
            </table>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-right: 10px;">
                      	...
                      	<p>We are small startup aiming to educate the society and to give a second chance to animal products.</p>
                      </td>
                    </tr>
                  </table>
                </td>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                      	...
                      	<ul>
					                <li><span class="text">XIV LO im. S. Staszica, Warsaw, Poland</span></li>
					                <li><span class="text">+31 420 692 137</span></a></li>
					              </ul>
                      </td>
                    </tr>
                  </table>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-left: 10px;">
                      	...
                      	<ul>
					                <li><a href="jhyfgrkujghghfdsdfgdvb">Home</a></li>
					              </ul>
                      </td>
                    </tr>
                  </table>
